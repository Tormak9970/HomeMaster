...
export function ListSearchTrigger({ entryLabel, labelOverride, options, onChange, TriggerIcon, determineEntryIcon, disabled }: ListSearchTriggerProps) {
  ...
  // //reference to dropdown component instance, which has a focus method
  ...
  const ModalWrapper: VFC<BaseModalProps> = ({ onSelectOption, rgOptions, closeModal }: BaseModalProps) => {
    ...
    return <ListSearchModal entryLabel={entryLabel} rgOptions={rgOptions!} onSelectOption={onSelectOption} determineEntryIcon={determineEntryIcon} closeModal={closeWrapper} />
  }
  ...
  // if (patchInput) {
  //   afterPatch(dropdown.type.prototype, 'render', function (_: any, ret: any) {
